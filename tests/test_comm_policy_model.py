...
def make_specs():
    ...
    output_spec = Composite(
        {
            GROUP: Composite(
                {"logits": Unbounded(shape=(N_AGENTS, N_ACTIONS))},
                shape=(N_AGENTS,),
            )
        }
    )
...
def test_model_forward_output_shape():
    ...
    logits = output_td.get((GROUP, "logits"))
...
def test_model_preserves_batch_and_agent_dimensions():
    ...
    output = output_td.get((GROUP, "logits"))
...
def test_shared_policy_has_one_encoder():
    model = make_model(share_params=True)
...
def test_unshared_policy_has_encoder_per_agent():
    model = make_model(share_params=False)
...
def test_model_rejects_centralised_usage():
    ...
    raise AssertionError("CommPolicyModel should reject centralised=True")
...
def test_model_rejects_critic_usage():
    ...
    raise AssertionError("CommPolicyModel should not be usable as a critic")
