...
2. Unzip the zip file and you can see the following 3 folders:
    ...
    * `case141_3min_final`
    * `case322_3min_final`
3. Go to the directory `[Your own parent path]/MAPDN/mapdn/environments/var_voltage_control/` and create a folder called `data`.
4. Move the 3 extracted folders by step 2 to the directory `[Your own parent path]/MAPDN/mapdn/environments/var_voltage_control/data/`.
...
```bash
ls mapdn/environments/var_voltage_control/data
```
